 ...
 */
(function () {
    this.MooTools = {version: "1.4.2", build: "552dfd4704fccffed444e0211c50831a2bfe209f"};
...
(function () {
    ...
    Object.forEach({getNext: "~", getPrevious: "!~", getParent: "!"}, function (e, r) {
    ...
    Element.implement({
        setProperty: function (e, r) {
            ...
            var t = this, e, v = Array.flatten(arguments), u = v.length;
            if (u > 1) {
    ...
    Element.implement({
        destroy: function () {
            ...
            v = v !== false;
            var A = this.cloneNode(v), s = [A], u = [this], y;
            if (v) {
            ...
            if (Browser.ie) {
                var B = A.getElementsByTagName("object"), C = this.getElementsByTagName("object");
                for (y = B.length; y--;) {
    ...
    [Element, Window, Document].invoke("implement", {
        addListener: function (t, s) {
            ...
            var t = f(Slick.uidOf(this)), s = t[r];
            if (e != null && s == null) {
                s = t[r] = e;
            }
    ...
    Element.Properties.html = (function () {
        ...
        if (!r) {
            var u = "abbr article aside audio canvas datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video".split(" "), t = document.createDocumentFragment(), e = u.length;
            while (e--) {
                t.createElement(u[e]);
            }
            t.appendChild(x);
        ...
        Element.Properties.value = {
            set: function (v) {
                ...
                for (var t = 0; t < s.length; t++) {
                    var u = s[t], e = u.getAttributeNode("value"), w = (e && e.specified) ? u.value : u.get("text");
                    if (w == v) {
                        return u.selected = true;
                    }
                }
            }, get: function () {
                var s = this, r = s.get("tag");
